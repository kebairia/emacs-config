...
** COMMENT ELFEED  _move it into another file_
#+begin_src emacs-lisp
  ;; data is stored in ~/.elfeed by defaults
  ;; use elfeed-org to handle your feed using org files
...
#+begin_src emacs-lisp
  ...
  (setq rmh-elfeed-org-files (list "~/.local/share/emacs/elfeed.org"))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (use-package mu4e
    ...
    ;;       '(("/z.kebairia@esi-sba.dz/INBOX"             . ?i)
    ;;         ("/z.kebairia@esi-sba.dz/[Gmail].Sent Mail" . ?s)
    ;;         ("/z.kebairia@esi-sba.dz/[Gmail].Spam"      . ?S)
