...
# ------------------------------------------------------------------------------
#+html: <a href="https://www.gnu.org/software/emacs/emacs.html#Releases"><img src="https://img.shields.io/badge/GNU%20Emacs-%2027.2%20-orange?style=for-the-badge&logo=emacsColor=blueviolet"></a>
#+html: <a href="https://orgmode.org"><img src="https://img.shields.io/badge/Org-literate%20config-%2377aa99?style=for-the-badge&logo=orgColor=white"></a>
# ------------------------------------------------------------------------------
* SCREENSHOTS
** scratch buffer
[[file:shots/scratch.png]]
** ibuffer
[[file:shots/ibuffer.png]]
** org-mode (emacs's configuration)
[[file:shots/org-mode.png]]
* BOOTSTRAP
:PROPERTIES:
